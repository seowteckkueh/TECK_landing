"""
Django settings for TECK_landing project.
...
SECRET_KEY = 'j@uu@68bg#tjdo-qo%v$1tk%%!f8+d*6uipa*h!)v8%0uq(85b'
...
ROOT_URLCONF = 'TECK_landing.urls'
...
WSGI_APPLICATION = 'TECK_landing.wsgi.application'
